ItemTypeMap = {
    ...
    armor1 = {
        ...
        "reinforce_footballhat",       --强化猪皮头盔
        "reinforce_armorsnurtleshell", --强化蜗牛壳
        "reinforce_armordragonfly",    --强化龙鳞盔甲
        "reinforce_armorseashell",     --强化贝壳甲
        "reinforce_armorcactus",       --强化仙人掌甲
        "reinforce_armor_bramble",     --强化荆棘甲
        "reinforce_slurtlehat",        --强化蜗牛头盔
        "reinforce_wathgrithrhat",     --强化女武神头盔
